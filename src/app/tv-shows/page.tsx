    ...
    <div className="relative min-h-screen bg-gradient-to-br from-[#181824] via-[#232946] to-[#181824]">
      ...
      <section className="bg-[#1a1a2e] border-b border-white/10">
        <div className="max-w-5xl mx-auto px-6 py-10 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3">TV Shows</h1>
          <p className="text-gray-400 text-lg">Explore and rate TV shows by wokeness level</p>
        </div>
      </section>
          ...
          <>
            {sortedShows.length === 0 ? (
              <EmptyState
                ...
                description="Try adjusting your filters or reset to see all TV shows."
